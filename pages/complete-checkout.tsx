        ...
        <div className="container-fluid">
            ...
            <div className="pt-70 pb-50">
                ...
                <p className="text-lg text-center color-palette-1 m-0">Kami akan periksa pembayaran Anda<br
                        className="d-sm-block d-none"/> dan kontak kami via
                    WhatsApp kirim bukti pembayaran anda</p>
            </div>
            <div className="button-group d-flex flex-column mx-auto">
                <a className="btn btn-dashboard fw-medium text-lg text-white rounded-pill mb-16"
                    href="./" role="button">
                    Back to home</a>
                <a className="btn btn-whatsapp fw-medium text-lg color-palette-1 rounded-pill" href="https://api.whatsapp.com/send?phone=6282175089146&text=%0A%0AHai%20Min%20Saya%20Telah%20melakukan%20pembayaran%20Berikut,%20Bukti%20PembayaranNya!%20berikut%20ini%20data%20pendaftaran%20saya%20%0ANamaSaya%20%3A%0AEvent%20%3A%20%0AEmail%0A"
