            ...
            <div className="container-fluid">
                <div className="row">
                    <div className="col-lg-4 text-lg-start text-center">
                        ...
                        <p className="mt-30 text-lg color-palette-1 mb-30">Umiers membantu
                              Mahasiswa mengembangkan pengetahuan dan keahliannya<br/></p>
                    ...
                    <div className="col-lg-8 mt-lg-0 mt-20">
                        <div className="row gap-sm-0">
                            ...
                            <div className="col-md-4 col-12 mt-lg-0 mt-md-0 mt-25">
                                <p className="text-lg fw-semibold color-palette-1 mb-12">KONTAK</p>
                                <ul className="list-unstyled">
                                    <li className="mb-6">
                                        <a href="mailto: hi@store.gg"
                                            className="text-lg color-palette-1 text-decoration-none">umi@gmail.com</a>
                                    </li>
                                   
                                    <li className="mb-6">
                                        <a href="http://maps.google.com/?q=Pasific 12,
                                        Jakarta Selatan" className="text-lg color-palette-1 text-decoration-none">BIRO REKTORAT UMI
                                            Jl Hang Tuah no 8, Madras Hulu Medan Polonia, Medan, 20151 </a>
                                    </li>
                                    <li className="mb-6">
                                        <a href="tel: 02111229090"
                                            className="text-lg color-palette-1 text-decoration-none">+62 61 415-7882</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
